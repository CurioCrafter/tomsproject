...
const captures = [
  ['drowned-cloister', 'drowned-belfry-cantors'],
  ['verdant-cathedral', 'bloodroot-reliquary'],
  ['ember-basilica', 'ember-choir-penitents'],
  ['amethyst-archives', 'amethyst-null-scribes'],
...
for (const [biome, encounterId] of captures) {
